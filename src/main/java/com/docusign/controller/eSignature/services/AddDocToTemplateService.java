...
public final class AddDocToTemplateService {
	...
	public static ViewUrl addDocumentToTemplate(
			...
			String dsReturnUrl,
			String dsPingUrl,
			WorkArguments args) throws ApiException, IOException {
		...
		RecipientViewRequest viewRequest = AddDocToTemplateService.makeRecipientViewRequest(
				...
				signerName,
				dsPingUrl);
		var createRecipientView = envelopesApi.createRecipientViewWithHttpInfo(accountId,
				envelopeSummary.getData().getEnvelopeId(), viewRequest);
	...
	// The envelope request object uses Composite Template to include in the
	// envelope:
	...
	public static EnvelopeDefinition makeEnvelope(
			...
			String ccName,
			String templateId,
			WorkArguments args) throws IOException {
		...
		// create a composite template for the added document and add the recipients via
		// an inlineTemplate
	...
	// Adding clientUserId transforms the template recipient into an embedded
	// recipient

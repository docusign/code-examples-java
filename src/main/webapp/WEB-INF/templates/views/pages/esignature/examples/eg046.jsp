...
<c:set var="deliveryMethod" value="0" scope="page" />
<c:set var="sms" value="1" scope="page" />
<c:set var="whatsapp" value="2" scope="page" />
<c:set var="signerNameInputNumber" value="3" scope="page" />
<c:set var="signerEmailInputNumber" value="4" scope="page" />
<c:set var="countryCodeInputNumber" value="5" scope="page" />
<c:set var="numberInputNumber" value="6" scope="page" />
<c:set var="ccSignerNameInputNumber" value="7" scope="page" />
<c:set var="ccEmailInputNumber" value="8" scope="page" />
<c:set var="ccCountryCodeInputNumber" value="9" scope="page" />
<c:set var="ccNumberInputNumber" value="10" scope="page" />

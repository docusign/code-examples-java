...
<div class="container" style="margin-top: 40px" id="index-page">
  ...
  <h2>Working with envelopes and templates</h2>
  ...
  <p>API methods used:
    ...
    <h2>Working with advanced recipient routing</h2>
  ...
  <h2>Implementing multi-factor recipient (signer) authentication</h2>

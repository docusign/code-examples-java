...
1.  Open the `src\main\resources\application.example.json` file. Configure the launcher by pasting the following data from your DocuSign developer account [Apps and Keys](https://admindemo.docusign.com/authenticate?goTo=apiIntegratorKey) page.  
The DS_SIGNER_NAME, DS_SIGNER_EMAIL, DS_TARGET_ACCOUNT_ID (the **API Username** in the **Apps and Keys** page),  
